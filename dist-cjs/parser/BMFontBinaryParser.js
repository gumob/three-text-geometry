...
class BMFontBinaryParser {
    parse(buf) {
        ...
        if (!header)
            throw new error_1.BMFontLoaderError(error_1.BMFontLoaderErrorType.ParseError, 'BMFont missing BMF byte header');
        let i = 3;
        const vers = buf.readUInt8(i++);
        if (vers > 3)
            throw new error_1.BMFontLoaderError(error_1.BMFontLoaderErrorType.ParseError, 'Only supports BMFont Binary v3 (BMFont App v1.10)');
        const target = (0, types_1.DefaultBMFont)();
        for (let b = 0; b < 5; b++)
    ...
    readInfo(buf, i) {
        const info = (0, types_1.DefaultBMFontInfo)();
    ...
    readCommon(buf, i) {
        const common = (0, types_1.DefaultBMFontCommon)();
    ...
    readKernings(buf, i, blockSize) {
        ...
        for (let c = 0; c < count; c++) {
            const kern = (0, types_1.DefaultBMFontKern)();
            const off = c * 10;
...
exports.BMFontBinaryParser = BMFontBinaryParser;
BMFontBinaryParser.HEADER = [66, 77, 70];
//# sourceMappingURL=BMFontBinaryParser.js.map