...
class BMFontXMLParser {
    parse(xml) {
        try {
            ...
            if (!font)
                throw new BMFontError('No font data in BMFont file');
            if (!font.pages)
                throw new BMFontError('No font data in BMFont file');
            if (!font.chars)
                throw new BMFontError('No chars data in BMFont file');
            if (!font.info)
                throw new BMFontError('No info data in BMFont file');
            if (!font.common)
                throw new BMFontError('No common data in BMFont file');
            let pages;
