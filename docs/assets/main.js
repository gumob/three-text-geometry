...
`,
  ...
  function me(t, e) {
    ...
    if (!r)
      (r = t.querySelector(e == 1 ? 'li:first-child' : 'li:last-child')), r && r.classList.add('current')
    else {
      let n = r
      if (e === 1)
 ...
 */
/**
 * lunr - http://lunrjs.com - A bit like Solr, but much smaller and not as bright - 2.3.9 Copyright (C) 2020
 * Oliver Nightingale
 *
 * @license MIT.
 */
